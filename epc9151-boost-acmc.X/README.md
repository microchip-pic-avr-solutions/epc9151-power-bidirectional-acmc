...
## EPC9151 300W 16th Brick Non-Isolated Step Up Converter Average Current Mode Control Firmware
**2-Phase Synchronous Boost Converter Operation**
...
This firmware project supports step-up operation from 12 V to 48 V only.
...
#### Product Features:
  - Input Voltage: 5 ... 15 V DC (12 V side)
  - Output Voltage: 18 V to 61 V (48 V side)
...
<p>
  <center>
    <img src="../mages/2-phase-acmc.png" alt="EPC9151 type II Mutli-Loop Average Current Mode Control Loop" width="800">
    <br>
