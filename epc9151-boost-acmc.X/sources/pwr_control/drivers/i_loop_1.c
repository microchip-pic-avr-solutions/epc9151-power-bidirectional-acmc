...
volatile int16_t i_loop_1_pre_scaler = 3;         // Bit-shift value used to perform input value normalization
volatile int16_t i_loop_1_post_shift_A = 0;       // Bit-shift value A used to perform control output value backfward normalization
volatile int16_t i_loop_1_post_shift_B = 5;       // Bit-shift value B used to perform control output value backfward normalization
volatile fractional i_loop_1_post_scaler = 0x0000; // Q15 fractional factor used to perform control output value backfward normalization
...
volatile uint16_t i_loop_1_Initialize(volatile struct NPNZ16b_s* controller)
{
    ...
    {
        i_loop_1_coefficients.ACoefficients[i] = i_loop_1_ACoefficients[i]; // Load coefficient A1 value into i_loop_1 coefficient data space
        i_loop_1_coefficients.ACoefficients[i] = i_loop_1_ACoefficients[i]; // Load coefficient A2 value into i_loop_1 coefficient data space
    }
    ...
    {
        i_loop_1_coefficients.BCoefficients[i] = i_loop_1_BCoefficients[i]; // Load coefficient B0 value into i_loop_1 coefficient data space
        i_loop_1_coefficients.BCoefficients[i] = i_loop_1_BCoefficients[i]; // Load coefficient B1 value into i_loop_1 coefficient data space
        i_loop_1_coefficients.BCoefficients[i] = i_loop_1_BCoefficients[i]; // Load coefficient B2 value into i_loop_1 coefficient data space
    }
