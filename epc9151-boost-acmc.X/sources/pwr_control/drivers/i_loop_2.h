...
} __attribute__((packed)) I_LOOP_2_CONTROL_LOOP_COEFFICIENTS_t; // Data structure packing A- and B- coefficient arrays in a linear memory space for optimized DSP code execution
...
} __attribute__((packed)) I_LOOP_2_CONTROL_LOOP_HISTORIES_t; // Data structure packing control and error histories arrays in a linear memory space for optimized DSP code execution
