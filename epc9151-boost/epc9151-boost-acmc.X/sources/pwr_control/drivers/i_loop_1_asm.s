; **********************************************************************************
;  SDK Version: z-Domain Control Loop Designer  v0.9.11.631
...
;------------------------------------------------------------------------------
    ...
    .global _i_loop_1_Update                ; provide global scope to routine
    _i_loop_1_Update:                       ; local function label
...
; Read data from input source and calculate error input to transfer function
    ...
    btsc [w0], #NPNZ16_STATUS_INVERT_INPUT  ; Test control bit if value should be inverted
    neg w1, w1                              ; invert value
...
;------------------------------------------------------------------------------
; Global function declaration i_loop_1_Reset
; This function clears control and error histories enforcing a reset
;------------------------------------------------------------------------------

    .global _i_loop_1_Reset                 ; provide global scope to routine
    _i_loop_1_Reset:                        ; local function label
...
;------------------------------------------------------------------------------
; Global function declaration i_loop_1_Precharge
; This function loads user-defined default values into control and error histories
;------------------------------------------------------------------------------

    .global _i_loop_1_Precharge             ; provide global scope to routine
    _i_loop_1_Precharge:                    ; local function label
...
;------------------------------------------------------------------------------
; End of file
    .end                                    ; end of file i_loop_1_asm.s
