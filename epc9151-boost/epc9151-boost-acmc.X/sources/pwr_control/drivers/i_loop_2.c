/* *********************************************************************************
 * z-Domain Control Loop Designer, Version 0.9.11.631
 * *********************************************************************************
...
{
    0x00007D2E, // Coefficient B0 will be multiplied with error input e(n-0)
    0x00000ECD, // Coefficient B1 will be multiplied with error input e(n-1)
    0x000091A0  // Coefficient B2 will be multiplied with error input e(n-2)
};

// Coefficient normalization factors
volatile int16_t i_loop_2_pre_scaler = 3;         // Bit-shift value used to perform input value normalization
volatile int16_t i_loop_2_post_shift_A = 0;       // Bit-shift value A used to perform control output value backfward normalization
volatile int16_t i_loop_2_post_shift_B = 5;       // Bit-shift value B used to perform control output value backfward normalization
volatile fractional i_loop_2_post_scaler = 0x0000; // Q15 fractional factor used to perform control output value backfward normalization
...
volatile uint16_t i_loop_2_Initialize(volatile struct NPNZ16b_s* controller)
{
    ...
    {
        i_loop_2_coefficients.ACoefficients[i] = i_loop_2_ACoefficients[i]; // Load coefficient A1 value into i_loop_2 coefficient data space
        i_loop_2_coefficients.ACoefficients[i] = i_loop_2_ACoefficients[i]; // Load coefficient A2 value into i_loop_2 coefficient data space
    }
    ...
    {
        i_loop_2_coefficients.BCoefficients[i] = i_loop_2_BCoefficients[i]; // Load coefficient B0 value into i_loop_2 coefficient data space
        i_loop_2_coefficients.BCoefficients[i] = i_loop_2_BCoefficients[i]; // Load coefficient B1 value into i_loop_2 coefficient data space
        i_loop_2_coefficients.BCoefficients[i] = i_loop_2_BCoefficients[i]; // Load coefficient B2 value into i_loop_2 coefficient data space
    }
